...
class WInActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val points = (10-rounds-2+lives) * 50 + lives * 50 + user!!.level
        ...
        pointsText.setText("+ "+((10-rounds-2+lives) * 100 + lives * 50 ).toString()+" "+ getString(R.string.points_text))
        ...
        if (startLevel!=finalLevel) {
            ...
            val textChangeAnimator = ValueAnimator.ofObject(TypeEvaluator<String> { fraction, startValue, endValue ->
                ...
                for (i in 0 until length) {
                    ...
                    result.append((cStart + (cEnd - cStart) * fraction).toChar())
                }
                result.toString()
            ...
            animatorSet.playSequentially(scaleAnimation, textChangeAnimator)
            animatorSet.start()
